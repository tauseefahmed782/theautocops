...
function Specification({ car_specification }) {
  return (
    <Accordion defaultActiveKey="">
      {car_specification.map((section, index) => (
              ...
              <div className="col-md-12">
                {section.attributes.map((attribute, i) => (
                  <React.Fragment key={i}>
                    <ul className='list-inline list_style d-flex justify-content-between m-0 py-2'>
